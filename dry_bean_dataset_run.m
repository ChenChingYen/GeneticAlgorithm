function [population, fitness_score, progress] = dry_bean_dataset_run()

% load dataset
data = readmatrix('dry_bean_dataset_csv_cleaned.csv');

input_layer_units = 16;
output_layer_units = 7;
...
rng('default');
% random seeds used for dry bean dataset are
% 12, 64, 90
rng(90);
